  ...
  return (
    <div className="w-full flex flex-col mb-24">
      ...
      <div className="ml-4 my-2 flex">
        <div className="bg-[#333] rounded-xl h-[170px] min-w-[170px] w-[170px] p-4 flex flex-col relative mr-4">
        ...
        <div className="bg-[#333] rounded-xl h-[170px] min-w-[170px] w-[170px] p-4 flex flex-col relative">
          <div className="bg-[#555] rounded-lg h-[50px] w-[50px] flex justify-center items-center">
      ...
      <div className="mx-4 my-4 px-4 py-2 rounded-xl flex justify-between border border-[#333]">
